...
Это называется **type erasure** — стирание типов. Интерфейсы, type alias, generic-типы — всё исчезает. В рантайме работает обычный JavaScript, и <CrossLink to="/ch04-v8-engine">движок V8</CrossLink> не знает, что код был написан на TypeScript.

<Callout type="warning">
TypeScript НЕ добавляет runtime-проверки. Если данные приходят из API, пользовательского ввода или JSON.parse — типы не гарантируют корректность. Для рантайм-валидации используйте Zod, io-ts или class-validator.
</Callout>
...
<DeepDive title="Soundness vs Completeness — формальный взгляд">
