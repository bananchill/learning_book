...
Это связано с тем, как работают [замыкания](/frontend/javascript/ch01-closures) — callback замыкается на переменную, но выполняется позже, когда значение могло измениться.
