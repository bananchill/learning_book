...
Как показано в [предыдущем разделе](/javascript/ch05-currying/04-real-world), точная типизация `curry` в TypeScript — задача для продвинутых магов типов. В командах это создаёт барьер.
