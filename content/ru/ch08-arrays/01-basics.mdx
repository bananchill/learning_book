...
<DeepDive title="Мутирующие vs немутирующие методы">
...
**Немутирующие (возвращают новый массив/значение):**
`map`, `filter`, `reduce`, `slice`, `concat`, `find`, `findIndex`, `some`, `every`, `includes`, `indexOf`
