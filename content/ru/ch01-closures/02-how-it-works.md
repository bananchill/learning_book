...
Все замыкания в цикле с `var` ссылаются на одну переменную → видят финальное значение. С `let` каждое замыкание получает свою копию. Подробный разбор — в [частых проблемах](/frontend/javascript/ch01-closures/03-common-problems).
...
Подробнее о context allocation и оптимизациях V8 — в главе [Движок V8: Context Allocation](/frontend/javascript/ch04-v8-engine/04-context-allocation).
