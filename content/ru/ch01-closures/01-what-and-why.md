...
Обе функции замкнулись на **одну и ту же** переменную `value`. Этот принцип объясняет классический баг с `var` в цикле — разберём в разделе про [частые проблемы](/frontend/javascript/ch01-closures/03-common-problems).
