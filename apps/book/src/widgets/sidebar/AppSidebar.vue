...
<template>
  ...
  >
    ...
    <div class="absolute bottom-0 left-0 right-0 border-t border-[var(--color-border)] p-4">
      <a
        href="https://github.com/bananchill/learning_book"
        target="_blank"
        rel="noopener noreferrer"
        class="flex items-center gap-2 text-sm text-[var(--color-text-secondary)] hover:text-[var(--color-text)] transition-colors"
      >
